...
<div class="rounded-xl overflow-hidden relati">
    <ul v-show="listShown" class="bg-purple-600 w-[20em] md:w-[45em] text-white grid grid-cols-2 top-[50%]  translate-y-[-50%] md:grid-cols-5 rounded-lg absolute left-[1.5em] md:left-[-2.5em] z-10 mt-2 overflow-hidden">
